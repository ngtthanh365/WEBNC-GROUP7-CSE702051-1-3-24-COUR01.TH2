                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="payment-methods">
                                <div class="row g-3">
                                    ...
                                    <!-- VNPay - Disabled -->
                                    <div class="col-md-6">
                                        <div class="payment-option  h-100" data-method="vnpay">
                                    ...
                                    {{-- Thêm stripe --}}
                                    <div class="col-md-6">
                                        <label class="payment-option  disabled h-100" data-method="stripe">
                                            ...
                                            <div class="d-flex align-items-center h-100">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Thanh toán bằng thẻ quốc tế (Visa/Master)</small>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                ...
                                <div class="cart-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            {{-- Sửa ảnh đoạn này --}}
                                                    <img src="{{ asset('storage/' . ($item->product->image_url ?? 'placeholder.svg')) }}"
